 ...
 */
case object PostProcessor extends SparkSqlMLBaseBaseListener {

  /** Remove the back ticks from an Identifier. */
  override def exitQuotedIdentifier(
    ctx: SparkSqlMLBaseParser.QuotedIdentifierContext): Unit = {
  ...
  override def exitNonReserved(ctx: SparkSqlMLBaseParser.NonReservedContext): Unit =
  ...
  private def replaceTokenByIdentifier(ctx: ParserRuleContext, stripMargins: Int)(
    ...
    val newToken = new CommonToken(
      ...
      SparkSqlMLBaseParser.IDENTIFIER,
      token.getChannel,
